...
final class ComposerJson implements ComposerJsonInterface
{
    ...
    private StringVo $fileSystemPathComposerJson;
    ...
    {
        $this->fileSystemPathComposerJson = StringVo::fromValue($fileSystemPathComposerJson->get()
            . DIRECTORY_SEPARATOR
            . self::FILE_NAME);

        Assert::readable($this->fileSystemPathComposerJson->toValue(), NamespaceProtectorExceptionInterface::MSG_PLAIN_ERROR_COMPOSER_JSON_NOT_READABLE);
    ...
    {
        $content = \safe\file_get_contents($this->fileSystemPathComposerJson->toValue());
